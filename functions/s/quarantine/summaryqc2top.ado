...
qui { // module 3 - perform data clumping
	...
	if !_rc {
		...
		!plink2 --bfile  `ldref' --clump ``function'_summaryqc_short'.top --clump-allow-overlap --clump-p1 `minp' --clump-p2 0.05 --clump-kb 1000 --clump-r2 0.1 --out ``function'_summaryqc_short'
